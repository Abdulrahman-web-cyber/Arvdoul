      ...
      try {
        ...
        if (targetUserId) {
          if (currentUser?.uid && targetUserId !== currentUser.uid) {
            ...
            if (caps && caps.canViewFollowing === false) {
              if (isMounted) {
        ...
        {loading ? (
          ...
          <div className="rounded-3xl p-8 sm:p-12 text-center border shadow-sm space-y-4 my-8 bg-white/80 dark:bg-[#0d1424]/80 border-slate-200 dark:border-white/10 backdrop-blur-xl">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Following List is Private</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                This citizen has chosen to restrict visibility of who they are following in accordance with their privacy settings.
              </p>
            </div>

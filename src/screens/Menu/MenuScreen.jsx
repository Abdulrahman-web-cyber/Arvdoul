...
export default function MenuScreen() {
  ...
  const mainNavItems = useMemo(() => [
    { icon: FaRocket, label: 'AI Creator Co-Pilot', description: 'Viral hooks, scripts & localization', color: '#a855f7', path: '/ai-studio', badge: 'AI Pro' },
    { icon: FaMicrophone, label: 'Live Audio Spaces', description: 'Voice lounges, stage tips & network', color: '#ef4444', path: '/spaces', badge: 'Live' },
    { icon: FaMusic, label: 'Trending Sounds', description: 'Viral audio tracks & music charts', color: '#ec4899', path: '/sounds', badge: 'Hot' },
    { icon: FaGem, label: 'Creator Marketplace', description: 'Buy & sell digital presets & merch', color: '#10b981', path: '/marketplace', badge: 'Store' },
    { icon: FaChartLine, label: 'Polls & Predictions', description: 'Vote & wager in prediction markets', color: '#3b82f6', path: '/polls', badge: 'Earn' },
  ...
  const createItems = useMemo(() => [
    { icon: FaRocket, label: 'AI Creator Studio', description: 'Viral captions, prompt crafter & scripts', color: '#a855f7', path: '/ai-studio', badge: 'AI' },
    { icon: FaMicrophone, label: 'Start Audio Space', description: 'Live voice stage & audience tipping', color: '#ef4444', path: '/spaces', badge: 'Live' },
    { icon: FaMusic, label: 'Upload Original Sound', description: 'Publish track to reels sound library', color: '#ec4899', path: '/sounds', badge: 'New' },
    { icon: FaGem, label: 'Sell Digital Product', description: 'List LUTs, sound kits & presets', color: '#10b981', path: '/marketplace', badge: '0% Fee' },
    { icon: FaChartLine, label: 'Create Poll & Market', description: 'Community voting & prediction pool', color: '#3b82f6', path: '/polls', badge: null },
    { icon: FaVideo, label: 'Video Studio Pro', description: '4K Multi-Track Timeline Editor', color: '#a855f7', path: '/video-editor', badge: 'PRO' },
    { icon: FaImage, label: 'Create Post', description: 'Share text, images, or polls', color: '#22c55e', path: '/create-post', badge: null },
    { icon: FaMusic, label: 'Audio Editor', description: 'Synthesize & mix audio', color: '#f97316', path: '/audio-editor', badge: null },
    { icon: FaCalendar, label: 'Create Event', description: 'Host a live event', color: '#38bdf8', path: '/event/create', badge: null },
  ...
  const discoverItems = useMemo(() => [
    { icon: FaRocket, label: 'AI Studio Suite', description: 'Viral hook generator & sentiment AI', color: '#a855f7', path: '/ai-studio', badge: 'AI' },
    { icon: FaMicrophone, label: 'Live Voice Lounges', description: 'Interactive audio stages', color: '#ef4444', path: '/spaces', badge: 'Active' },
    { icon: FaMusic, label: 'Music & Sounds Hub', description: 'Viral waveforms & beat stems', color: '#ec4899', path: '/sounds', badge: 'Trends' },
    { icon: FaGem, label: 'Creator Store', description: 'Digital goods, LUTs & apparel', color: '#10b981', path: '/marketplace', badge: 'Shop' },
    { icon: FaChartLine, label: 'Prediction Markets', description: 'Wager coins on future outcomes', color: '#3b82f6', path: '/polls', badge: 'Wager' },
    { icon: FaVideo, label: 'Video Studio', description: 'Multi-Track Pro Editor', color: '#8b5cf6', path: '/video-editor', badge: 'Studio' },
    ...
    { icon: FaRocket, label: 'Creator Analytics', description: 'Performance & insights', color: '#8b5cf6', path: '/profile/analytics', badge: null },

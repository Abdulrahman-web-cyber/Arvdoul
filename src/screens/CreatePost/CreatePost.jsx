...
const VISIBILITY_OPTIONS = [
  { id: "public", label: "Public", icon: Icons.Globe, color: "text-blue-500" },
  { id: "followers", label: "Followers", icon: Icons.Users, color: "text-green-500" },
  { id: "friends", label: "Friends", icon: Icons.UserCheck, color: "text-indigo-500" },
  { id: "subscribers", label: "Subscribers", icon: Icons.Star, color: "text-amber-500" },
  { id: "only_me", label: "Only Me", icon: Icons.Lock, color: "text-gray-500" },
];

const MONETIZATION_TYPES = [
  { id: "none", label: "Free", fee: 0 },
  { id: "tip_jar", label: "Tip Jar", fee: 0 },
  { id: "subscription", label: "Subscribers Only", fee: 5 },
  { id: "ppv", label: "Pay-Per-View", fee: 10 },
];

const BOOST_TIERS = [
  { id: "none", label: "No Boost", icon: Icons.Minus, coins: 0, multiplier: 1 },
  { id: "low", label: "2x Reach", icon: Icons.Zap, coins: 50, multiplier: 2 },
  { id: "medium", label: "5x Reach", icon: Icons.TrendingUp, coins: 100, multiplier: 5, recommended: true },
  { id: "high", label: "10x Ultra Boost", icon: Icons.Flame, coins: 250, multiplier: 10 },
];

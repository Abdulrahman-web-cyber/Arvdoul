      ...
      creatorSuite: [
        {
          label: "AI Studio Pro",
          icon: Sparkles,
          action: () => navigate(NAVIGATION_PATHS.aiStudio),
          color: "from-purple-600 via-pink-600 to-indigo-600",
          description: "Viral hooks & AI scriptwriter",
          badge: "AI Pro",
          sparkling: true
        },
        {
          label: "Audio Spaces",
          icon: Radio,
          action: () => navigate(NAVIGATION_PATHS.spaces),
          color: "from-rose-500 via-red-500 to-orange-500",
          description: "Live voice stage & coin tips",
          badge: "Live"
        },
        {
          label: "Trending Sounds",
          icon: Music,
          action: () => navigate(NAVIGATION_PATHS.sounds),
          color: "from-pink-500 via-rose-500 to-purple-500",
          description: "Viral waveforms & stem library",
          badge: "Hot"
        },
        {
          label: "Creator Store",
          icon: ShoppingBag,
          action: () => navigate(NAVIGATION_PATHS.marketplace),
          color: "from-emerald-500 via-teal-500 to-green-600",
          description: "Sell presets, LUTs & merch",
          badge: "0% Fee"
        },
        {
          label: "Polls & Wagers",
          icon: BarChart3,
          action: () => navigate(NAVIGATION_PATHS.polls),
          color: "from-blue-500 via-indigo-500 to-cyan-500",
          description: "Voting & prediction markets",
          badge: "Earn"
        },
        {
          label: "Video Studio",
          icon: Video,
          action: () => navigate(NAVIGATION_PATHS.videoEditor),
          color: "from-amber-500 via-orange-500 to-red-500",
          description: "Multi-track 4K timeline editor",
          badge: "Pro"
        }
      ]
    };
    ...
    >
      <div>
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          ...
          <Badge variant="creator">PRO SUITE</Badge>
        </div>
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
          Next-gen creative suite: Viral hook AI, live audio stages, sound discovery, digital marketplace & prediction pools.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {quickActions.creatorSuite?.map((tool, index) => (
            <motion.button
              key={tool.label}
              ...
              className={cn(
                "p-3.5 sm:p-4 rounded-2xl text-left border relative overflow-hidden",
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                {tool.badge && (
                  <span className={cn(
                    ...
                    "bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 border border-purple-400/20"
                  )}>
                    {tool.badge}
                  </span>
                )}
              ...
              <div className="mt-3 flex items-center text-xs font-semibold text-purple-600 dark:text-purple-400 gap-1">
              ...
              <div className="mt-4 sm:mt-6 mb-4 sm:mb-6">
                <div className="flex overflow-x-auto pb-2 -mx-4 sm:mx-0 px-4 sm:px-0 sm:flex sm:space-x-1 sm:p-1 rounded-xl bg-gray-100/50 dark:bg-gray-800/50">
                  {[
                    ...
                    { id: "studio", label: "Studio Hub", icon: Sparkles },

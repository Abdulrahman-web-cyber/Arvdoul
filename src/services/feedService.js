...
const feedService = {
  ...
  savePost: (pid, uid) => firestoreService.savePost(pid, uid),
  unsavePost: (pid, uid) => firestoreService.unsavePost(pid, uid),
  bookmarkPost: (pid, uid) => firestoreService.savePost(pid, uid),
  sharePost: (pid, uid) => firestoreService.sharePost(pid, uid),
  addReaction: (pid, uid, reaction) => firestoreService.addReaction(pid, uid, reaction),
  removeReaction: (pid, uid) => firestoreService.removeReaction(pid, uid),
  recordPostView: (pid, uid) => firestoreService.recordPostView(pid, uid),
  createPost: (data) => firestoreService.createPost(data),
  getPost: (id, opts) => firestoreService.getPost(id, opts)
};

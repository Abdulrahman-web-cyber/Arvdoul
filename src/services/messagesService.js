...
const messagesService = messagingService;
const getMessagesService = getMessagingService;

export default messagingService;
export { messagingService, messagesService, getMessagingService, getMessagesService, MESSAGING_CONFIG };
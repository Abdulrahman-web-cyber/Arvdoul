...
//       logger.warn('Avatar fallback used');
  ...
  async createUserProfile(userId, profileData) {
    ...
    const profile = {
      ...
      profileCompletedAt: profileData.isProfileComplete ? serverTimestamp() : null,
...
export const generateUniqueUsername = (base, exclude) => getUserService().generateUniqueUsername(base, exclude);
